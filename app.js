 ...
 function berechneDruckhoehe(){
    ...
    }else{pressAlt = fieldelev + (1013-qnh) * 8;}
    console.log(pressAlt);
    document.getElementById("outPressAlt").innerText = pressAlt.toFixed(0)+ " "+ distUnit;
 ...
 function berechneDichtehoehe(){
    ...
    document.getElementById("outDensAlt").innerText = densAlt.toFixed(0) +" "+ distUnit;
